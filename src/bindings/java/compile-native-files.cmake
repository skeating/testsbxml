...
message("Creating: libtsb.jar")

# find all sources
file(GLOB_RECURSE SOURCE_FILES RELATIVE ${BIN_DIRECTORY} ${BIN_DIRECTORY}/java-files/org/tsb/libtsb/*.java)
...
if (EXISTS ${BIN_DIRECTORY}/libtsb.jar)
	file(REMOVE ${BIN_DIRECTORY}/libtsb.jar)	
endif()
...
file(GLOB_RECURSE CLASS_FILES RELATIVE ${BIN_DIRECTORY}/java-files ${BIN_DIRECTORY}/java-files/org/tsb/libtsb/*.class)
