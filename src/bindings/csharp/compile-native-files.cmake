...
message("Creating: libtsbcsP.dll")
...
if (EXISTS ${BIN_DIRECTORY}/libtsbcsP.dll)
    file(REMOVE ${BIN_DIRECTORY}/libtsbcsP.dll)	
endif()
...
file(TO_NATIVE_PATH ${BIN_DIRECTORY}/libtsbcsP.dll MANAGED_LIB)
